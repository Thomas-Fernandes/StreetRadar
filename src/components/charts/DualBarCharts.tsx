...
const DualBarCharts: React.FC<DualBarChartsProps> = ({
    ...
    const currentSelectedCountry =
        selectedCountry !== undefined ? selectedCountry : internalSelectedCountry;
    ...
    useEffect(() => {
        const loadDefaultContinent = async () => {
            try {
                ...
                const topContinent = Object.entries(continentTotals).sort(
                    ([, a], [, b]) => b - a
                )[0];
    ...
    return (
        ...
        >
            ...
            {!filters && (
                <ChartControls filters={currentFilters} onFiltersChange={handleFiltersChange} />
            )}
