...
const TimelineChart: React.FC<TimelineChartProps> = ({
    ...
    const processDataForTimeline = useCallback(
        (data: CoverageData[]) => {
            ...
            const totalLabel = isPanoramas
                ? `${countryPrefix}Total Panoramas`
                : `${countryPrefix}Total Coverage`;
            const monthlyLabel = isPanoramas
                ? `${countryPrefix}Monthly Panoramas`
                : `${countryPrefix}Monthly Addition`;
    ...
    const options = {
        ...
        plugins: {
            title: {
                ...
                text:
                    title ||
                    `${selectedCountry ? `${selectedCountry} - ` : ''}${filters?.metric === 'panoramas' ? 'Panoramas' : 'Coverage'} Evolution Timeline`,
                font: {
