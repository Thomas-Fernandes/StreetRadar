...
export default function StatisticsPanel({ isOpen, onToggle }: StatisticsPanelProps) {
    ...
    const [providerBreakdown, setProviderBreakdown] = useState<{
        [provider: string]: { kilometers: string; panoramaCount: string };
    }>({});
        ...
        <>
            ...
            {!isOpen && (
                <div className="statistics-button-container">
                    ...
                    <div className="statistics-button-tooltip">Statistics</div>
                </div>
            )}
            ...
            <div className={`statistics-panel ${isOpen ? 'open' : ''}`}>
                                        ...
                                        {loading
                                            ...
                                            : error
                                              ...
                                              : providerBreakdown.Google
                                                ? providerBreakdown.Google.kilometers
                                                : 'Coming Soon'}
                                    </span>
                                </div>
                                <div className="provider-stat-item">
                                    ...
                                    <span className="provider-stat-value">
                                        {loading
                                            ...
                                            : error
                                              ? 'Error'
                                              : providerBreakdown.Bing
                                                ? providerBreakdown.Bing.kilometers
                                                : 'Coming Soon'}
                                    </span>
                                </div>
                                <div className="provider-stat-item">
                                    ...
                                    <span className="provider-stat-value">
                                        {loading
                                            ...
                                            : error
                                              ? 'Error'
                                              : providerBreakdown.Apple
                                                ? `${providerBreakdown.Apple.kilometers} km`
                                                : '-- km'}
                                    </span>
                                </div>
                                <div className="provider-stat-item">
                                    ...
                                    <span className="provider-stat-value">
                                        {loading
                                            ...
                                            : error
                                              ? 'Error'
                                              : providerBreakdown.Yandex
                                                ? providerBreakdown.Yandex.kilometers
                                                : 'Coming Soon'}
                                    </span>
                                </div>
                            </div>
                ...
                {isChartModalOpen && (
                    <div
                        className={`chart-modal-overlay ${isModalClosing ? 'closing' : ''}`}
                        onClick={toggleChartsExpansion}
                    >
                        <div
                            className={`chart-modal-content ${isModalClosing ? 'closing' : ''}`}
