...
const LayerControl: React.FC<LayerControlProps> = ({ visibleLayers, toggleLayer }) => {
    return (
        <div className="absolute top-3 right-3 z-10 bg-white bg-opacity-90 rounded-lg shadow-md p-3 w-64">
            <h3 className="text-gray-800 font-medium mb-2 text-sm">Street View Layers</h3>
            ...
            <div className="space-y-2">
                <div className="flex items-center">
                    ...
                    <label
                        ...
                        className="ml-2 text-[#4285F4] cursor-pointer text-sm"
                    >
                        Google Street View
                    </label>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <label
                        htmlFor="bing-layer"
                        className="ml-2 text-[#8661C5] cursor-pointer text-sm"
                    >
                        Bing Streetside
                    </label>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <label
                        ...
                        className="ml-2 text-[#FF0000] cursor-pointer text-sm"
                    >
                        Yandex Panoramas
                    </label>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <label
                        htmlFor="naver-layer"
                        className="ml-2 text-[#00c851] cursor-pointer text-sm"
                    >
                        Naver Street View
                    </label>
                </div>
