...
export class PanoramaService {
    ...
    static async detectPanoramasAt(
        ...
        return StreetViewDetectionCanvas.detectStreetViewAt(map, latlng, activeProviders);
    }
    ...
    static getProviderName(provider: string): string {
        switch (provider) {
            ...
            case 'bing':
                return 'Bing Streetside';
            case 'yandex':
                return 'Yandex Panoramas';
            case 'apple':
                return 'Apple Look Around';
            case 'naver':
                return 'Naver Street View';
            case 'ja':
                return 'Já 360 Street View';
            default:
                return provider;
        }
    }
